		...
		<div class="colorlib-product">
			<div class="container">
				...
				<div class="row row-pb-md">
					<?php
					$select_product = mysqli_query($connection, "SELECT * from add_product as p inner join
					add_cat as c on p.p_cat = c.cat_id where c.cat_name = 'best seller'");
					if(mysqli_num_rows($select_product) > 0){
						while ($data = mysqli_fetch_assoc($select_product)){
					...
					<div class="col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<a href="#" class="prod-img">
								<img src="<?php echo '../admin/uploade/' .$data['image']?>" class="img-fluid" alt="Free html5 bootstrap 4 template">
							</a>
							<div class="desc">
								<h2><a href="#"><?php echo $data['p_name']?> </a></h2>
